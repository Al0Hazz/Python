...
pygame.display.set_caption("飞船大战游戏")

clock = pygame.time.Clock()

# 图片
alien_image = pygame.image.load('C:/Users/Al0Ha/Desktop/游戏/alien.png')
ship_image = pygame.image.load('C:/Users/Al0Ha/Desktop/游戏/ship.png')
bullet_image = pygame.image.load('C:/Users/Al0Ha/Desktop/游戏/bullet.png')
star_image = pygame.image.load('C:/Users/Al0Ha/Desktop/游戏/star.png')
bj_image = pygame.image.load('C:/Users/Al0Ha/Desktop/游戏/bj.png')
bj1_image = pygame.image.load('C:/Users/Al0Ha/Desktop/游戏/bj1.png')

bj_rect = bj_image.get_rect()

bj1_rect = bj1_image.get_rect()
...
# 添加Play按钮
play_button = pygame.Rect(300, 350, 200, 100)  # 按钮的位置和大小
newgame_button = pygame.Rect(300, 350, 200, 100)  # 新游戏按钮的位置和大小
exit_button = pygame.Rect(750, 350, 200, 100)  # 退出按钮的位置和大小
game_over = False

def draw_play_button():
    pygame.draw.rect(screen, (0,0,0), play_button)  # 绘制矩形作为按钮
    font = pygame.font.Font(None, 36)  # 设置字体和大小
    text = font.render("play", True, (255,255,255))  # 渲染文字
    text_rect = text.get_rect(center=play_button.center)  # 设置文字位置为按钮中心
    screen.blit(text, text_rect)  # 绘制文字

def draw_newgame_button():
    pygame.draw.rect(screen, (0,0,0), newgame_button)  # 绘制矩形作为按钮
    font = pygame.font.Font(None, 36)  # 设置字体和大小
    text = font.render("newgame", True, (255,255,255))  # 渲染文字
    text_rect = text.get_rect(center=newgame_button.center)  # 设置文字位置为按钮中心
    screen.blit(text, text_rect)  # 绘制文字

def draw_exit_button():
    pygame.draw.rect(screen, (0,0,0), exit_button)  # 绘制矩形作为按钮
    font = pygame.font.Font(None, 36)  # 设置字体和大小
    text = font.render("exit", True, (255,255,255))  # 渲染文字
...
while running:
    ...
    if game_over:
        screen.fill((0, 0, 0))  # 清空屏幕
        screen.blit(bj1_image, bj1_rect)
